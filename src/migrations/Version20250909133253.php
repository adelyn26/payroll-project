 ...
 */
final class Version20250909133253 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE payroll_deductions (deduction_id INT NOT NULL, payroll_id INT NOT NULL, INDEX IDX_EF05194F2319F88E (deduction_id), INDEX IDX_EF05194FDBA340EA (payroll_id), PRIMARY KEY(deduction_id, payroll_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE document (id INT AUTO_INCREMENT NOT NULL, employee_id INT DEFAULT NULL, doc_type VARCHAR(255) NOT NULL, file_path VARCHAR(255) NOT NULL, INDEX IDX_D8698A768C03F15C (employee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE employee (id INT AUTO_INCREMENT NOT NULL, company_id INT DEFAULT NULL, identification_number VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, position VARCHAR(255) NOT NULL, salary INT NOT NULL, hiring_date DATE NOT NULL, period_end DATE NOT NULL, is_active TINYINT(1) NOT NULL, type_of_contract VARCHAR(255) NOT NULL, INDEX IDX_5D9F75A1979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE leave_request (id INT AUTO_INCREMENT NOT NULL, employee_id INT DEFAULT NULL, leave_type VARCHAR(255) NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, status VARCHAR(255) NOT NULL, reason VARCHAR(255) NOT NULL, INDEX IDX_7DC8F7788C03F15C (employee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE payroll_deductions ADD CONSTRAINT FK_EF05194F2319F88E FOREIGN KEY (deduction_id) REFERENCES deduction (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE payroll_deductions ADD CONSTRAINT FK_EF05194FDBA340EA FOREIGN KEY (payroll_id) REFERENCES payroll (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE payroll_deductions DROP FOREIGN KEY FK_EF05194F2319F88E
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE payroll_deductions DROP FOREIGN KEY FK_EF05194FDBA340EA
        SQL);
        $this->addSql(<<<'SQL'
