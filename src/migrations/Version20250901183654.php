 ...
 */
final class Version20250901183654 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE company (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, rnc VARCHAR(100) NOT NULL, sector VARCHAR(100) NOT NULL, address VARCHAR(100) NOT NULL, phone_number VARCHAR(100) NOT NULL, email VARCHAR(100) NOT NULL, plan VARCHAR(100) NOT NULL, amount_employee VARCHAR(100) NOT NULL, database_name VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
